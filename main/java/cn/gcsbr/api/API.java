...
import static cn.gcsbr.api.API.Definition.UNIVERSAL;
import static cn.gcsbr.api.API.Usage.BLEEDING;

/**
 * Describes an API element.
 *
 * @author Lin Mulan, gcsbr Project
 * @see Usage
 * @see Definition
 */
...
public @interface API {
    ...
    enum Definition {
        ...
        /**
         * Intended for features should only be used by gcsbr itself.
